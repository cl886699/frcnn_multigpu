...
if __name__ == '__main__':
    ...
    with dist_strategy.scope():
        if os.name == 'nt':
            ...
            tf_record_path = '../../../../../datasets/dota/old_tfrecord/'
            train_dir = './train_dir/'
        train_datasets, val_datasets = ZipDotaDataset(tf_record_path, GLOBAL_BATCHSIZE,
                                                      crop_size=[512, 512, 3]).prepare(True, False)
        ...
        model = faster_rcnn.FasterRCNN(num_classes=17)
        ...
        # print(cc)
        model.summary()
        trainer = DistTrainer(dist_strategy, model, 16, num_devices, trian_dir=train_dir)
        trainer.train(train_datasets, val_datasets)
